...
categories: ML
tag: [Splines, Basis Expansion,Regression Splines, Python]
typora-root-url: ..\
...
이는 truncated power basis에서 boundary의 차수는 1임을 이용하여 $$N1,N2$$를 유도할 수 있고, 나머지는 위의 식을 넣어서 truncated power basis와 비교하면 같음을 알 수 있다. 
